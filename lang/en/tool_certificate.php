...
$string['notificationmsgcertificateabouttoexpire'] = 'Hi {$a->fullname},<br /><br />Your certificate will expire soon! You will find it here:
<a href="{$a->url}">My Certificates</a> <p> Expiry date : {$a->expires}';
...
$string['notificationsubjectcertificateabouttoexpire'] = 'Your certificate will expire soon!';
