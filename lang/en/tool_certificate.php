...
$string['enableexpirynotification'] = 'Enable Expiry Notification';
...
$string['expirynotificationmessage'] = 'Expiry notification message';
$string['expirydateremindernotification'] = 'Expiry date Reminder Notification';
...
$string['notificationmsgcertificateabouttoexpire'] = 'Hi {$a->fullname},<br /><br />Your <strong>{$a->coursefullname}</strong> certificate will expire soon! You will find it here:
<a href="{$a->url}">My Certificates</a> <p> <strong>Expiry date</strong> : {$a->expires}';
...
$string['notificationsubjectcertificateabouttoexpire'] = 'Your <strong>{$a->coursefullname}</strong> certificate will expire soon!';
